<template>
    <svg viewBox="0 0 24 24" width="24" height="24" fill="currentColor" class="bili-video-card__info--owner__up"
        version="1.1" id="svg3" sodipodi:docname="danmakus.svg" inkscape:version="1.3.2 (091e20e, 2023-11-25, custom)"
        ...
        <circle style="fill-opacity:1" id="path1" r="1" cy="10.175" cx="6.9120002" />
        <rect style="fill-opacity:1;stroke-width:1.16662" id="rect1" width="7.3429999" height="2" x="9.125" y="9.1906595"
            ry="1" />
        <ellipse style="fill-opacity:1" id="path1-4" cy="14.081" cx="8.4440002" rx="1.0000001" ry="1" />
        <rect style="fill-opacity:1;stroke-width:1.16662" id="rect1-3" width="7.3430004" height="2" x="10.657" y="13.09666"
            ry="1" />
    </svg>
</template>